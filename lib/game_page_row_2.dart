import 'package:bulls_eye/game_page_model.dart';
...
class GamePageRow2 extends StatefulWidget {
  const GamePageRow2({Key? key, required this.model}) : super(key: key);

  final GamePageModel model;

  @override
  _GamePageRow2State createState() => _GamePageRow2State();
}

class _GamePageRow2State extends State<GamePageRow2> {
